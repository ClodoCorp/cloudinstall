...
x86_64:
	...
	bash -c 'env GO15VENDOREXPERIMENT=1 CGO_ENABLED=0 go build -a -o "$${tmp}/init2"' ;\
...
x86_32:
	...
	cp data/init "$${tmp}/init" ;\
	bash -c 'env GO15VENDOREXPERIMENT=1 CGO_ENABLED=0 GOARCH=386 go build -a -o "$${tmp}/init2"' ;\
